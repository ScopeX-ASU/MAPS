...
def main():
    ...
    parser.add_argument("--image_path", type=str, default="/home/hzhou144/projects/MAPS_local/data/fdfd/optical_diode/prefab/corrected_design_prediction.png")
    ...
    diode_opt_simulation(random_seed, device, image_path=image_path)

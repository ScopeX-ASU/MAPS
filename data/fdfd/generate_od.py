...
def optical_diode_opt(device_id, operation_device, each_step=False, include_perturb=False, perturb_probs=[0.05, 0.1, 0.15]):
    ...
    def perturb_and_dump(step, flip_prob=0.1, i=None):
        ...
        with DeterministicCtx(seed=42 + step + i):
            ...
            try:
                ...
                filename_h5 = dump_data_path + f"/optical_diode_id-{device_id}_opt_step_{step}_perturbed_{i}.h5"
                filename_yml = dump_data_path + f"/optical_diode_id-{device_id}_perturbed_{i}.yml"
    ...
    for step in range(n_epoch):
        ...
        filename_h5 = dump_data_path + f"/optical_diode_id-{device_id}_opt_step_{step}.h5"

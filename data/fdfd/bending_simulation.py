...
def main():
    ...
    parser.add_argument("--image_path", type=str, default="/home/hzhou144/projects/MAPS_local/data/fdfd/bending/prefab/corrected_design_prediction.png")
    ...
    bending_simulation(random_seed, device, image_path=image_path)

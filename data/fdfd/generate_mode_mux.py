...
def mode_mux_opt(
    ...
    dump_data_path = f"./data/fdfd/mode_mux/raw_opt_traj_ptb"
    ...
    assert (
        round(region_size[0] + 2 * port_len, 2) == target_cell_size
    ), f"right hand side: {region_size[0] + 2 * port_len}, target_cell_size: {target_cell_size}"
    ...
    sim_cfg.update(
        dict(
            ...
            plot_root=f"./data/fdfd/mode_mux/plot_opt_traj_ptb/mode_mux_{device_id}",
            PML=[0.5, 0.5],
            neural_solver=None,
        ...
        with DeterministicCtx(seed=42 + step + i):
            ...
            try:
                ...
                opt.plot(
                    ...
                    plot_filename=f"mode_mux_opt_step_{step}_mode1_fwd_perturbed_{i}.png",
                ...
                opt.plot(
                    ...
                    plot_filename=f"mode_mux_opt_step_{step}_mode2_fwd_perturbed_{i}.png",
                    field_key=("in_slice_2", 1.55, "Ez1", 300),
                    field_component="Ez",
    ...
    for step in range(n_epoch):
        ...
        filename_h5 = dump_data_path + f"/mode_mux_id-{device_id}_opt_step_{step}.h5"
        filename_yml = dump_data_path + f"/mode_mux_id-{device_id}.yml"
        ...
        if last_design_region_dict is None:
            ...
            opt.plot(
                eps_map=opt._eps_map,
                obj=results["breakdown"]["mode1_trans"]["value"],
                plot_filename="mode_mux_opt_step_{}_mode1_fwd.png".format(step),
                field_key=("in_slice_1", 1.55, "Ez1", 300),
                field_component="Ez",
                in_slice_name="in_slice_1",
                exclude_slice_names=[],
            ...
            opt.plot(
                eps_map=opt._eps_map,
                obj=results["breakdown"]["mode2_trans"]["value"],
                plot_filename="mode_mux_opt_step_{}_mode2_fwd.png".format(step),
                field_key=("in_slice_2", 1.55, "Ez1", 300),
                field_component="Ez",
                in_slice_name="in_slice_2",
                exclude_slice_names=[],
...
def main():
    ...
    mode_mux_opt(random_seed, device, each_step, include_perturb)

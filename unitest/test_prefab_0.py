...
def port_tf_to_torch(tf_model, torch_model):
    ...
    # BN1
    torch_model.bn1.weight.data.copy_(torch.from_numpy(td["batch_normalization/gamma:0"]))
    torch_model.bn1.bias.data.copy_(torch.from_numpy(td["batch_normalization/beta:0"]))
    torch_model.bn1.running_mean.data.copy_(torch.from_numpy(td["batch_normalization/moving_mean:0"]))
    torch_model.bn1.running_var.data.copy_(torch.from_numpy(td["batch_normalization/moving_variance:0"]))
    ...
    # BN2
    torch_model.bn2.weight.data.copy_(torch.from_numpy(td["batch_normalization_1/gamma:0"]))
    torch_model.bn2.bias.data.copy_(torch.from_numpy(td["batch_normalization_1/beta:0"]))
    torch_model.bn2.running_mean.data.copy_(torch.from_numpy(td["batch_normalization_1/moving_mean:0"]))
    torch_model.bn2.running_var.data.copy_(torch.from_numpy(td["batch_normalization_1/moving_variance:0"]))
    ...
    # BN3
    torch_model.bn3.weight.data.copy_(torch.from_numpy(td["batch_normalization_2/gamma:0"]))
    torch_model.bn3.bias.data.copy_(torch.from_numpy(td["batch_normalization_2/beta:0"]))
    torch_model.bn3.running_mean.data.copy_(torch.from_numpy(td["batch_normalization_2/moving_mean:0"]))
    torch_model.bn3.running_var.data.copy_(torch.from_numpy(td["batch_normalization_2/moving_variance:0"]))
    ...
    # BN4
    torch_model.bn4.weight.data.copy_(torch.from_numpy(td["batch_normalization_3/gamma:0"]))
    torch_model.bn4.bias.data.copy_(torch.from_numpy(td["batch_normalization_3/beta:0"]))
    torch_model.bn4.running_mean.data.copy_(torch.from_numpy(td["batch_normalization_3/moving_mean:0"]))
    torch_model.bn4.running_var.data.copy_(torch.from_numpy(td["batch_normalization_3/moving_variance:0"]))

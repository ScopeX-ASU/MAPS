...
def port_tf_to_torch(tf_model, torch_model):
    ...
    torch_model.bn1.weight.data.copy_(
        torch.from_numpy(td["batch_normalization_12/gamma:0"])
    )
    torch_model.bn1.bias.data.copy_(
        torch.from_numpy(td["batch_normalization_12/beta:0"])
    )
    torch_model.bn1.running_mean.data.copy_(
        torch.from_numpy(td["batch_normalization_12/moving_mean:0"])
    )
    torch_model.bn1.running_var.data.copy_(
        torch.from_numpy(td["batch_normalization_12/moving_variance:0"])
    )
    ...
    torch_model.bn2.weight.data.copy_(
        torch.from_numpy(td["batch_normalization_13/gamma:0"])
    )
    torch_model.bn2.bias.data.copy_(
        torch.from_numpy(td["batch_normalization_13/beta:0"])
    )
    torch_model.bn2.running_mean.data.copy_(
        torch.from_numpy(td["batch_normalization_13/moving_mean:0"])
    )
    torch_model.bn2.running_var.data.copy_(
        torch.from_numpy(td["batch_normalization_13/moving_variance:0"])
    )
    ...
    torch_model.bn3.weight.data.copy_(
        torch.from_numpy(td["batch_normalization_14/gamma:0"])
    )
    torch_model.bn3.bias.data.copy_(
        torch.from_numpy(td["batch_normalization_14/beta:0"])
    )
    torch_model.bn3.running_mean.data.copy_(
        torch.from_numpy(td["batch_normalization_14/moving_mean:0"])
    )
    torch_model.bn3.running_var.data.copy_(
        torch.from_numpy(td["batch_normalization_14/moving_variance:0"])
    )
    ...
    torch_model.bn4.weight.data.copy_(
        torch.from_numpy(td["batch_normalization_15/gamma:0"])
    )
    torch_model.bn4.bias.data.copy_(
        torch.from_numpy(td["batch_normalization_15/beta:0"])
    )
    torch_model.bn4.running_mean.data.copy_(
        torch.from_numpy(td["batch_normalization_15/moving_mean:0"])
    )
    torch_model.bn4.running_var.data.copy_(
        torch.from_numpy(td["batch_normalization_15/moving_variance:0"])
    )

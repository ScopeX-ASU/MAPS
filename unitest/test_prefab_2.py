...
def port_tf_to_torch(tf_model, torch_model):
    ...
    torch_model.bn1.weight.data.copy_(
        torch.from_numpy(td["batch_normalization_8/gamma:0"])
    )
    torch_model.bn1.bias.data.copy_(
        torch.from_numpy(td["batch_normalization_8/beta:0"])
    )
    torch_model.bn1.running_mean.data.copy_(
        torch.from_numpy(td["batch_normalization_8/moving_mean:0"])
    )
    torch_model.bn1.running_var.data.copy_(
        torch.from_numpy(td["batch_normalization_8/moving_variance:0"])
    )
    ...
    torch_model.bn2.weight.data.copy_(
        torch.from_numpy(td["batch_normalization_9/gamma:0"])
    )
    torch_model.bn2.bias.data.copy_(
        torch.from_numpy(td["batch_normalization_9/beta:0"])
    )
    torch_model.bn2.running_mean.data.copy_(
        torch.from_numpy(td["batch_normalization_9/moving_mean:0"])
    )
    torch_model.bn2.running_var.data.copy_(
        torch.from_numpy(td["batch_normalization_9/moving_variance:0"])
    )
    ...
    torch_model.bn3.weight.data.copy_(
        torch.from_numpy(td["batch_normalization_10/gamma:0"])
    )
    torch_model.bn3.bias.data.copy_(
        torch.from_numpy(td["batch_normalization_10/beta:0"])
    )
    torch_model.bn3.running_mean.data.copy_(
        torch.from_numpy(td["batch_normalization_10/moving_mean:0"])
    )
    torch_model.bn3.running_var.data.copy_(
        torch.from_numpy(td["batch_normalization_10/moving_variance:0"])
    )
    ...
    torch_model.bn4.weight.data.copy_(
        torch.from_numpy(td["batch_normalization_11/gamma:0"])
    )
    torch_model.bn4.bias.data.copy_(
        torch.from_numpy(td["batch_normalization_11/beta:0"])
    )
    torch_model.bn4.running_mean.data.copy_(
        torch.from_numpy(td["batch_normalization_11/moving_mean:0"])
    )
    torch_model.bn4.running_var.data.copy_(
        torch.from_numpy(td["batch_normalization_11/moving_variance:0"])
    )

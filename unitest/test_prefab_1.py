...
def port_tf_to_torch(tf_model, torch_model):
    ...
    # Conv1
    W = td["conv2d_4/kernel:0"]   # (3,3,1,1)
    b = td["conv2d_4/bias:0"]     # (1,)
    ...
    # BN1
    torch_model.bn1.weight.data.copy_(torch.from_numpy(td["batch_normalization_4/gamma:0"]))
    torch_model.bn1.bias.data.copy_(torch.from_numpy(td["batch_normalization_4/beta:0"]))
    torch_model.bn1.running_mean.data.copy_(torch.from_numpy(td["batch_normalization_4/moving_mean:0"]))
    torch_model.bn1.running_var.data.copy_(torch.from_numpy(td["batch_normalization_4/moving_variance:0"]))

    # Conv2
    W = td["conv2d_5/kernel:0"]   # (3,3,1,2)
    b = td["conv2d_5/bias:0"]     # (2,)
    ...
    # BN2
    torch_model.bn2.weight.data.copy_(torch.from_numpy(td["batch_normalization_5/gamma:0"]))
    torch_model.bn2.bias.data.copy_(torch.from_numpy(td["batch_normalization_5/beta:0"]))
    torch_model.bn2.running_mean.data.copy_(torch.from_numpy(td["batch_normalization_5/moving_mean:0"]))
    torch_model.bn2.running_var.data.copy_(torch.from_numpy(td["batch_normalization_5/moving_variance:0"]))

    # Conv3
    W = td["conv2d_6/kernel:0"]   # (3,3,2,4)
    b = td["conv2d_6/bias:0"]     # (4,)
    ...
    # BN3
    torch_model.bn3.weight.data.copy_(torch.from_numpy(td["batch_normalization_6/gamma:0"]))
    torch_model.bn3.bias.data.copy_(torch.from_numpy(td["batch_normalization_6/beta:0"]))
    torch_model.bn3.running_mean.data.copy_(torch.from_numpy(td["batch_normalization_6/moving_mean:0"]))
    torch_model.bn3.running_var.data.copy_(torch.from_numpy(td["batch_normalization_6/moving_variance:0"]))

    # Conv4
    W = td["conv2d_7/kernel:0"]   # (3,3,4,8)
    b = td["conv2d_7/bias:0"]     # (8,)
    ...
    # BN4
    torch_model.bn4.weight.data.copy_(torch.from_numpy(td["batch_normalization_7/gamma:0"]))
    torch_model.bn4.bias.data.copy_(torch.from_numpy(td["batch_normalization_7/beta:0"]))
    torch_model.bn4.running_mean.data.copy_(torch.from_numpy(td["batch_normalization_7/moving_mean:0"]))
    torch_model.bn4.running_var.data.copy_(torch.from_numpy(td["batch_normalization_7/moving_variance:0"]))

    # Dense
    W = td["dense_1/kernel:0"]     # (512, 16384)
    b = td["dense_1/bias:0"]       # (16384,)
...
path = "./thirdparty/PreFab/models/p_ANT_NanoSOI_v0.1_1.pb"

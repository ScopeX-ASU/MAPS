...
def port_tf_to_torch(tf_model, torch_model):
    ...
    torch_model.bn1.weight.data.copy_(
        torch.from_numpy(td["batch_normalization_4/gamma:0"])
    )
    torch_model.bn1.bias.data.copy_(
        torch.from_numpy(td["batch_normalization_4/beta:0"])
    )
    torch_model.bn1.running_mean.data.copy_(
        torch.from_numpy(td["batch_normalization_4/moving_mean:0"])
    )
    torch_model.bn1.running_var.data.copy_(
        torch.from_numpy(td["batch_normalization_4/moving_variance:0"])
    )
    ...
    torch_model.bn2.weight.data.copy_(
        torch.from_numpy(td["batch_normalization_5/gamma:0"])
    )
    torch_model.bn2.bias.data.copy_(
        torch.from_numpy(td["batch_normalization_5/beta:0"])
    )
    torch_model.bn2.running_mean.data.copy_(
        torch.from_numpy(td["batch_normalization_5/moving_mean:0"])
    )
    torch_model.bn2.running_var.data.copy_(
        torch.from_numpy(td["batch_normalization_5/moving_variance:0"])
    )
    ...
    torch_model.bn3.weight.data.copy_(
        torch.from_numpy(td["batch_normalization_6/gamma:0"])
    )
    torch_model.bn3.bias.data.copy_(
        torch.from_numpy(td["batch_normalization_6/beta:0"])
    )
    torch_model.bn3.running_mean.data.copy_(
        torch.from_numpy(td["batch_normalization_6/moving_mean:0"])
    )
    torch_model.bn3.running_var.data.copy_(
        torch.from_numpy(td["batch_normalization_6/moving_variance:0"])
    )
    ...
    torch_model.bn4.weight.data.copy_(
        torch.from_numpy(td["batch_normalization_7/gamma:0"])
    )
    torch_model.bn4.bias.data.copy_(
        torch.from_numpy(td["batch_normalization_7/beta:0"])
    )
    torch_model.bn4.running_mean.data.copy_(
        torch.from_numpy(td["batch_normalization_7/moving_mean:0"])
    )
    torch_model.bn4.running_var.data.copy_(
        torch.from_numpy(td["batch_normalization_7/moving_variance:0"])
    )
